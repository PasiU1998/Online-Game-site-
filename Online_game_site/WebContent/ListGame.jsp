...
<link re="stylesheet" href="css/gameCard.css">



<title>FlashPlay-Action Games</title>
</head>
	...
	<section class="page-top-section set-bg">
				...
				<nav class="navbar navbar-expand-lg navbar navbar-dark w-100 p-3">
					...
					<div class="collapse navbar-collapse" id="navbarSupportedContent">
						<ul class="navbar-nav mr-auto">
							...
							<li class="nav-item"><a
								class="nav-link  ml-5 h4 octicon person material-icons"
								href="User_profile.jsp"><%=userName%></a></li>
						</ul>
		...
		<div class="page-info">
			...
			<div class="site-breadcrumb">
				<a href="">Home</a> / <span>Game List</span>
			</div>
		</div>
	</section>
	<!-- Page top end-->
		...
		<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
			<div class="row">
				...
				<%
					...
					int catoid = Integer.valueOf(request.getParameter("catoId"));
					Item Item_view = new Item();
					ArrayList<Item> items = itemService.getitems(catoid);
					for (Item item : items) {
				%>
				<div
					class="game-card card card bg-light mb-3 col-md-3 col-sm-4 col-xs-6">
					...
					<div class="card-body">
						...
						<p class="card-text text-danger text-bold">
							Rate :
							<%=item.getItem_rate()%>/10
						</p>
						<a href="Single_Item.jsp?itemID=<%=item.getItem_id()%>"
							class="btn btn-primary" action=<%%>>View</a>
					</div>
