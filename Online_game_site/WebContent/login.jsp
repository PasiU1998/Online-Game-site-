...
<body>
						...
						<ul class="navbar-nav mr-auto">
							...
							<li class="nav-item dropdown"><a
								...
								<div class="dropdown-menu" aria-labelledby="navbarDropdown">
									...
									<li class="nav-item"><a
							class="nav-link  ml-5 h4 octicon person material-icons" href="feedback.jsp">Feedback</a></li>
							<li class="nav-item"><a class="nav-link  ml-5 h4 octicon "
								href="#"></a></li>
						</ul>
	...
	<div class="login-form">
		<form action="Login_Servelet" method="post">
			<div class="avatar">
