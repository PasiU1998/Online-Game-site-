	...
	<section class="page-top-section set-bg">
		...
		<div class="page-info">
			...
			<div class="site-breadcrumb">
				<a href="admin.jsp">Admin</a> / <span>Admin feedback Update</span>
			</div>
		</div>
	</section>
	<!-- Page top end-->
					...
					<table
						...
						<tr>
							<td class="pt-3-half" contenteditable="true"><input
								type="text" placeholder=<%=f1.getName()%> name="name"></input></td>
							<td class="pt-3-half" contenteditable="true"><input
								type="text" placeholder=<%=f1.getEmail()%> name="email"></input></td>
							<td class="pt-3-half" contenteditable="true"><input
								type="text" placeholder=<%=f1.getFeedback()%> name="feedback"></input></td>
							>
