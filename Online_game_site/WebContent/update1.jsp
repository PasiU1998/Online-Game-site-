...
</head><%@page import="java.sql.DriverManager"%>
...
<table border="1">
<caption style="font-size: 30px;">Update</caption>
<tr>
<th>Game ID</th>
<th>Game Name</th>
<th>Description</th>
...
<td><a href="update.jsp?id=<%=resultSet.getString("gameid")%>">
<button type="button" class="update" style="font-size: 30px; background-color: yellow; border-radius: 8px; border: none;">Update</button></a></td>
</tr>
<% 
}
connection.close();
